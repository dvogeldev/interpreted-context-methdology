...
9. **Ask about deployment environments and branch strategy:**
    - What deployment environments will this project use (e.g., local, staging, production) and where will environment variables be managed?
    - What is the preferred branch strategy for local development?
    These answers will inform environment-specific file handling and git workflow conventions.
10. **[Checkpoint]** -- Present the workflow map draft to the user. Ask: Are all stages captured? Any missing inputs or outputs? Any stages to combine or split?
11. Run the audit checks below. If any fail, revise before saving.
12. Write the workflow map summarizing everything discovered.

## Checkpoints

| After Step | Agent Presents | Human Decides |
|------------|---------------|---------------|
| 9 | Draft workflow map: all stages with inputs/outputs, shared context, variables, tools, skills | Whether the stage breakdown, handoff points, and shared context are correct |
